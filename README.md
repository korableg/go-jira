...
[![GoDoc](https://pkg.go.dev/badge/github.com/korableg/go-jira?utm_source=godoc)](https://pkg.go.dev/github.com/korableg/go-jira)
[![Build Status](https://github.com/korableg/go-jira/actions/workflows/testing.yml/badge.svg)](https://github.com/korableg/go-jira/actions/workflows/testing.yml)
[![Go Report Card](https://img.shields.io/badge/go%20report-A+-brightgreen.svg?style=flat)](https://goreportcard.com/report/github.com/korableg/go-jira)
...
See our milestone [Road to v2](https://github.com/korableg/go-jira/milestone/1) and provide feedback in [Development is kicking: Road to v2 🚀 #489](https://github.com/korableg/go-jira/issues/489).
...
**If you want to stay more stable, please use v1.\*** - See our [releases](https://github.com/korableg/go-jira/releases).
Latest stable release: [v1.16.0](https://github.com/korableg/go-jira/releases/tag/v1.16.0)
...
```sh
go get github.com/korableg/go-jira
```

## API

Please have a look at the [GoDoc documentation](https://pkg.go.dev/github.com/korableg/go-jira) for a detailed API description.
...
A few more examples are available in the [GoDoc examples section](https://pkg.go.dev/github.com/korableg/go-jira#section-directories).
...
import (
	"fmt"
	jira "github.com/korableg/go-jira"
)
...
For more details have a look at the [issue #56](https://github.com/korableg/go-jira/issues/56).
...
Please look at [Pagination Example](https://github.com/korableg/go-jira/blob/main/cloud/examples/pagination/main.go)
...
Creating issues or holding talks and help other people to use [go-jira](https://github.com/korableg/go-jira) is contribution, too!
A few examples:

* Correct typos in the README / documentation
* Reporting bugs
* Implement a new feature or endpoint
* Sharing the love of [go-jira](https://github.com/korableg/go-jira) and help people to get use to it
...
[https://github.com/korableg/go-jira/releases/edit/v1.11.0](https://github.com/korableg/go-jira/releases/edit/v1.11.0)
